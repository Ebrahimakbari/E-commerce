...
bucket_url = [
    ...
    path('delete_obj_bucket/<path:key>', view=views.DeleteObjectBucketView.as_view(), name='delete_obj_bucket'),
    path('download_obj_bucket/<path:key>', view=views.DownloadObjectBucketView.as_view(), name='download_obj_bucket'),
]
